 ...
 * @author chengjian
 * @version 1.0
 * @date 2018年09月20日 10:15
 */
public class QimenResponseUtil {


    public static <T> T success( Class<T> clazz){
        return createQimenResponse("success","0","处理成功!","", new HashMap<String, String>(),clazz);
    }
    ...
    public static <T> T fail(String message,Class<T> clazz){
        return createQimenResponse("failure","50","处理失败!","",new HashMap<String, String>(),clazz);
    }
