...
import org.shrek.hadata.service.hwms.service.AbstractOutBoundService;
...
public class JzteyOutBoundServiceImpl extends AbstractOutBoundService<TiSendOrderJztey> implements OutBoundService<TiSendOrderJztey> {

    @Autowired
    TiSendOrderJzteyMapper tiSendOrderJzteyMapper;
    @Autowired
    ...
    protected void insertExtend(TiSendOrderMaster<TiSendOrderJztey> master) {
        TiSendOrderJztey jztey = master.getExtend();
        jztey.setMasterId(master.getId());
        tiSendOrderJzteyMapper.insertSelective(jztey);
    }

    @Override
    public List<HashMap<String, String>> queryOutBounds(HashMap<String, String> params) {
        return tiSendOrderJzteyMapper.selectOutBoundsToJztey(params);
    }
