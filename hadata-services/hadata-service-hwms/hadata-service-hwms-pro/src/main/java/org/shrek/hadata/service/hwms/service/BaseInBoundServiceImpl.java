...
public class BaseInBoundServiceImpl implements InBoundService<String> {
    ...
    @Override
    public boolean createInBounds(List<TiReceiveOrderMaster<String>> tiReceiveOrderMasters) {
        return false;
    }
