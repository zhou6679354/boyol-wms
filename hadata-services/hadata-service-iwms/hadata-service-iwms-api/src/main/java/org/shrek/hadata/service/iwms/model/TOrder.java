...
public class TOrder extends BasicEntity {
    ...
    @Column(name = "massive_control")
    private String massiveControl;
    @Column(name = "TMS_syn_times")
    private Integer tmsSynTimes;
    @Column(name = "TMS_syn_status")
    private Integer tmsSynStatus;
    @Column(name = "TMS_syn_time")
    private Date tmsSynTime;
    @Column(name = "TMS_syn_remark")
    ...
    @Transient
    private List<TOrderDetail> orderDetailList= Lists.newArrayList();
    @Transient
